...
namespace iroha{
    namespace consensus{
        ...
        message::ConsensusPeerMessage consensusProxy::getPeerMessage(std::string message_type, std::string content){
        ...
        message::ConsensusBroadcastResponse consensusProxy::handleConsensusBroadcastReq(message::ConsensusBroadcastRequest request){
            ...
            message::ConsensusPeerMessage peermsg=getPeerMessage(request.message_type(), request.content());
            broadcast(peermsg);
        ...
        message::ConsensusSummarizeBlockResponse consensusProxy::handleBlockSumReq(message::ConsensusSummarizeBlockRequest request){
            message::ConsensusSummarizeBlockResponse ans;
            ans.set_summary(canditateBlock.summary());
            ans.set_status(message::ConsensusSummarizeBlockResponse_Status::ConsensusSummarizeBlockResponse_Status_OK);
            return ans;
        }
        void consensusProxy::NotifyBlockNew(){
            ...
            message::Message msg;
            msg.set_message_type(message::Message_MessageType::Message_MessageType_CONSENSUS_NOTIFY_BLOCK_NEW);
            std::string buf;
        ...
        void consensusProxy::NotifyBlockValid(std::string blockid){
            ...
            message::Message msg;
            msg.set_message_type(message::Message_MessageType::Message_MessageType_CONSENSUS_NOTIFY_BLOCK_VALID);
            std::string buf;
        ...
        void consensusProxy::NotifyBlockInvalid(std::string blockid){
            ...
            message::Message msg;
            msg.set_message_type(message::Message_MessageType::Message_MessageType_CONSENSUS_NOTIFY_BLOCK_INVALID);
            std::string buf;
        ...
        message::ConsensusFinalizeBlockResponse consensusProxy::handleBlockFinalReq(message::ConsensusFinalizeBlockRequest request){
        ...
        message::ConsensusCheckBlocksResponse consensusProxy::handleBlockCheckReq(message::ConsensusCheckBlocksRequest request){
        ...
        message::Message consensusProxy::handleEngineMessage(message::Message request){
            ...
            if(request.message_type()==message::Message::CONSENSUS_REGISTER_REQUEST){
            ...
            }else if(request.message_type()==message::Message::CONSENSUS_INITIALIZE_BLOCK_REQUEST){
                message::ConsensusInitializeBlockRequest initreq;
                initreq.ParseFromString(request.content());
                message::ConsensusInitializeBlockResponse initres=handleBlockInitReq(initreq);
                initres.SerializeToString(&buf);
                ans.set_content(buf);
                ans.set_message_type(message::Message::CONSENSUS_INITIALIZE_BLOCK_RESPONSE);
            }else if(request.message_type()==message::Message::CONSENSUS_SUMMARIZE_BLOCK_REQUEST){
                message::ConsensusSummarizeBlockRequest sumreq;
                sumreq.ParseFromString(request.content());
                message::ConsensusSummarizeBlockResponse sumres=handleBlockSumReq(sumreq);
                sumres.SerializeToString(&buf);
                ans.set_content(buf);
                ans.set_message_type(message::Message::CONSENSUS_SUMMARIZE_BLOCK_RESPONSE);
            }else if(request.message_type()==message::Message::CONSENSUS_FINALIZE_BLOCK_REQUEST){
                message::ConsensusFinalizeBlockRequest finalreq;
                finalreq.ParseFromString(request.content());
                message::ConsensusFinalizeBlockResponse finalres=handleBlockFinalReq(finalreq);
                ...
                message::ConsensusCheckBlocksResponse checkres=handleBlockCheckReq(checkreq);
                checkres.SerializeToString(&buf);
                ans.set_content(buf);
                ans.set_message_type(message::Message::CONSENSUS_CHECK_BLOCKS_RESPONSE);
            }else if(request.message_type()==message::Message::CONSENSUS_COMMIT_BLOCK_REQUEST){
                message::ConsensusCommitBlockRequest commitreq;
                commitreq.ParseFromString(request.content());
                message::ConsensusCommitBlockResponse commitres=handleBlockCommitReq(commitreq);
